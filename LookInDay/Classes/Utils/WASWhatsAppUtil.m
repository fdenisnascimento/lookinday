...
- (void)alertWhatsappNotInstalled{
	[[[UIAlertView alloc] initWithTitle:@"Mensagem Digital" message:@"Para compartilhar com o WhatsApps é preciso que o mesmo seja instalado." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
}
